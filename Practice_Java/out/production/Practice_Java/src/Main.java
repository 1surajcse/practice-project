...
public class Main {
    public static void main(String[] args) {
        ...
        Map<Character, Long> fre = s.chars().mapToObj(c -> (char) c).collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));
        ...
        System.out.println(immutableClassSample.getAge());
...
//
        ...
        map.entrySet().stream().sorted(Map.Entry.comparingByKey()).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (o, n) -> o));
        LinkedHashMap<Integer, List<Employee>> maps = map.entrySet().stream().sorted(Map.Entry.comparingByKey()).
